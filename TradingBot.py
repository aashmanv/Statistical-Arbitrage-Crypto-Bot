#to use this bot, go to binance and generate an API key to trade on futures. Input API key on lines 8 and 9, and scroll to the bottom of this file to input the desired ticker and order quantity.
#initialize packages
...
#Main loop. Enter ticker of any trading pair supported on binance futures, enter order quantity, and set desired leverage on binance suggested leverage is 50x.
while True:
